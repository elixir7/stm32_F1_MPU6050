...
void _Gyro_Cali(float x_min, float x_max, float y_min, float y_max, float z_min, float z_max)
{
	//1* X-Axis calibrate
	G_X_Bias		= (x_max + x_min)/2.0f;
	
	//2* Y-Axis calibrate
	G_Y_Bias		= (y_max + y_min)/2.0f;
	
	//3* Z-Axis calibrate
	G_Z_Bias		= (z_max + z_min)/2.0f;
}
